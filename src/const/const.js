...
export const jobs = [
  {
    ...
    title: "Vivero Takumi",
    link: "https://viverotakumi.com.ar/",
...
export const projects = [
  {
    ...
    title: "Informental",
    link: "https://informental.com.ar/",
    description: `Portafolio de un ecommerce con pasarela de pagos stripe integrada, destalles de el product etc.  `,
    technologies: [
      {
        icon: IconKeys.typeScript,
      },
